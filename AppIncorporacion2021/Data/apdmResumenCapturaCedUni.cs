...
{
    class apdmResumenCapturaCedUni
    {
        private int idApdmResumenEncuestaCedUni;
        private string folio_encuesta;
        private string idEncuesta;
        private string idProceso;
        private string cupo;
        private string usuarioCapturaDm;
        ...
        private string idAgeb;
        private string gpsLongitud;
        private string gpsLatitud;

        public int IdApdmResumenEncuestaCedUni
        {
            get
            {
                return idApdmResumenEncuestaCedUni;
            }

            set
            {
                idApdmResumenEncuestaCedUni = value;
            }
        }
        ...
        public string UsuarioCapturaDm
        {
            get
            {
                return usuarioCapturaDm;
            }

            set
            {
                usuarioCapturaDm = value;
            }
        }
